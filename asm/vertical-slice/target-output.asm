...
.routine out A,carry,zero clobbers sign,parity,halfCarry,C,DE,HL,IY
TargetEmitSourceProvenanceSinglePart:
            ...
            LD   A,1
            LD   C,0
            JP   TargetSinkSourceProvenanceSinglePartCode
...
FinishTargetFlatProgram:
            ...
            CALL TargetEmitSourceProvenanceSinglePart
