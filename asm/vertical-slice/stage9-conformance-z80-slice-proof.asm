...
Chapter21_19FalseSource:
            .db "const Rows = 17",10
Chapter21_19FalsePoint:
            .db "assert Rows <= 16",10
            .db 10
            .db "sub main()",10
            .db "end",10
Chapter21_19FalseSourceEnd:

Chapter21_19TypeSource:
            .db "const Rows = 8",10
Chapter21_19TypePoint:
            .db "assert Rows",10
            .db 10
            .db "sub main()",10
            .db "end",10
...
ProofStart:
            ...
            JP   C,ProofFailed
            LD   A,83
            LD   HL,Chapter21_19ControlSource
            LD   DE,Chapter21_19ControlSourceEnd
            CALL ProofBuildSingle
            JP   C,ProofFailed
            CALL ProofComparePublishedProgram
            JP   C,ProofFailed
