...
| `stage7-tables.asmi`        | Generated prediction, production, and action tables included by the compiler.                       |
...
test after changing the grammar or generator. The recursive-descent Stage 7
fixture remains only as a differential oracle while later language stages are
added to the LL(1) grammar.
