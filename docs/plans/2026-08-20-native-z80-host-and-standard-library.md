...
Fixup capacity remains 32. Structured-control labels remain below 27, `main`
remains label 27, and ordinary routines begin at 28. Source routine labels may
then extend above 31 without being truncated into bank metadata. Definition,
...
Proofs must discriminate labels 31, 32, and 43 in local and cross-bank calls,
...
The initial console module is deliberately small:
...
The first formatting module supplies the routines needed by programs and the
