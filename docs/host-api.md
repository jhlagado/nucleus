...
lets Node prove the native monitor architecture before a hardware filesystem
and runtime provider are complete. The
[MON3-compatible compiler host](mon3-host-binding.md) defines its layout and
service selectors.
