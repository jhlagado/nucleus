...
import { materializeNobj, NobjGenerationStore, } from "./nobj.js";
import { commitNobjAdapterGeneration as commitNobjAdapterGenerationWithProvider, commitNobjAdapterGenerationTo as commitNobjAdapterGenerationToWithProvider, } from "./nobj-adapter.js";
...
export const commitNobjAdapterGeneration = async (generation) => {
    const runtimeLinkContext = generation.runtimeLinkContext ?? defaultRuntimeLinkContext;
...
export const commitNobjAdapterGenerationTo = async (generation, output) => {
    const runtimeLinkContext = generation.runtimeLinkContext ?? defaultRuntimeLinkContext;
    const runtimeProvider = await loadCanonicalRuntimeProvider([
        runtimeLinkContext,
    ]);
    return commitNobjAdapterGenerationToWithProvider({ ...generation, runtimeLinkContext, runtimeProvider }, output);
};
