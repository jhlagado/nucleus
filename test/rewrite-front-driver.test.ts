...
describe("ground-up rewrite source-driven routine body", () => {
  it("parses a complete nested routine body from source", () => {
    ...
    expect(records).toEqual([
      { name: "DeclareLocal16", bytes: [8, 0] },
      { name: "Literal16", bytes: [9, 0, 0] },
      { name: "StoreLocal16", bytes: [38, 0] },
      { name: "DeclareLocalU8", bytes: [2, 2] },
      { name: "Literal16", bytes: [9, 0, 0] },
      { name: "StoreLocalU8", bytes: [6, 2] },
      { name: "ControlLabelDirect", bytes: [42, 0] },
      { name: "Literal16", bytes: [9, 1, 0] },
      { name: "BranchFalse", bytes: [44, 1] },
      { name: "LoadLocal16", bytes: [11, 0] },
      { name: "Literal16", bytes: [9, 0, 0] },
      { name: "Compare16", bytes: [34, 128] },
      { name: "BranchFalse", bytes: [44, 3] },
      { name: "Literal16", bytes: [9, 1, 0] },
      { name: "StoreLocal16", bytes: [38, 0] },
      { name: "JumpDirect", bytes: [45, 2] },
      { name: "ControlLabelDirect", bytes: [42, 3] },
      { name: "Literal16", bytes: [9, 0, 0] },
      { name: "BranchFalse", bytes: [44, 4] },
      { name: "JumpDirect", bytes: [45, 0] },
      { name: "JumpDirect", bytes: [45, 2] },
      { name: "ControlLabelDirect", bytes: [42, 4] },
      {
        name: "CallSource",
        bytes: [58, 0, 0, 0, 1, 127, 0, 3, 5, 0],
      },
      { name: "SkipHandler", bytes: [81, 6] },
      { name: "BeginHandlerLocal", bytes: [84, 5, 9, 2] },
      { name: "Literal16", bytes: [9, 2, 0] },
      { name: "StoreLocal16", bytes: [38, 0] },
      { name: "EndHandler", bytes: [85, 6] },
      { name: "JumpDirect", bytes: [45, 1] },
      { name: "ControlLabelEnclosing", bytes: [43, 2] },
      { name: "JumpEnclosing", bytes: [46, 0] },
      { name: "ControlLabelEnclosing", bytes: [43, 1] },
      { name: "EndFailableRoutineDirect", bytes: [79, 0] },
